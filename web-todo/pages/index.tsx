...
import * as style from '../styles/layout.styles'

const Home: NextPage = () => {
    return (
        <div css={style.outline}>
            <Head>
                <title>Web ToDo</title>
            </Head>

            <div css={style.loginCard}>
                <h1 css={style.title}>Web ToDo<br css={style.titleBr} /> for Google Tasks</h1>
                <h2 css={style.titleSub}>by cffnpwr</h2>
                <Link href='https://google.com'>
                    <a>
                        <button css={style.loginButton}>
                            <svg css={style.loginGIcon} width="18" height="18" viewBox="0 0 18 18" version="1.1">
